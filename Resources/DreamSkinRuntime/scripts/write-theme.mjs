...
const name = validateText(valueFor("name", "My Codex Dream Skin"), "name", 80, "My Codex Dream Skin");
const tagline = validateText(
  valueFor("tagline", "Turn a favorite image into an interactive Codex workspace."),
  "tagline",
  120,
  "Turn a favorite image into an interactive Codex workspace.",
);
...
const custom = {
  schemaVersion: 1,
  id: `custom-${Date.now()}`,
  name: name || "My Codex Dream Skin",
  brandSubtitle: "CODEX DREAM SKIN",
  tagline: tagline || "Turn a favorite image into an interactive Codex workspace.",
